namespace :crondonkulous do
  ...
  task :every_minute => :environment do
    crondonkulous_wrapper(Rails.root.join("log/every_minute.log"), 0) do
      #your code here
    end
  end
  ...
  task :every_5_minutes => :environment do
    crondonkulous_wrapper(Rails.root.join("log/every_5_minutes.log"), 0) do
      #your code here
    end
  end
  ...
  task :every_15_minutes => :environment do
    crondonkulous_wrapper(Rails.root.join("log/every_15_minutes.log"), 0) do
      #your code here
    end
  end
  ...
  task :every_hour => :environment do
    crondonkulous_wrapper(Rails.root.join("log/every_hour.log"), 0) do
      #your code here
    end
  end
  ...
  task :every_week => :environment do
    crondonkulous_wrapper(Rails.root.join("log/every_week.log"), 0) do
      #your code here
    end
  end
  ...
  task :every_month => :environment do
    crondonkulous_wrapper(Rails.root.join("log/every_month.log"), 0) do
      #your code here
    end
  end
...
def crondonkulous_wrapper(logfile, retries = 0)
  ...
  begin
    Lockfile.new(Rails.root.join("log/crondonkulous.lock"), :retries => retries) do      
      yield
    end
